...
const App = () => {
  ...
  const content = {
    ...
    outlet: {
      ...
      description: "Una selezione di pezzi unici da sposa e da cerimonia a prezzi esclusivi per realizzare i sogni di ognuna di voi. Brand prestigiosi, occasioni uniche.",
  ...
  return (
    <div
      className={`min-h-screen ${current.bgColor} transition-colors duration-700 ease-in-out`}
    >
      <div className="min-h-screen flex flex-col">

        {/* Header */}
        <header
          className={`w-full py-4 md:py-6 px-4 md:px-8 flex items-center justify-between ${
        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <a
              ...
              className={`${current.textColor} hover:opacity-70 transition-all duration-300`}
              aria-label="Facebook"
            >
              ...
              >
                ...
                >
                  <img
                    ...
                    className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] xl:h-[600px] object-cover transition-transform duration-700"
                  />
                </div>
              </div>
            </div>
        ...
        >
          <p className={`font-sans text-xs md:text-sm ${current.accentColor} transition-colors duration-500`}>
